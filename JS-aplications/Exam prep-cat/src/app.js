...
function updateNav() {
    ...
    if (userData) {
        Array.from(document.querySelectorAll('.user')).forEach(el => el.style.display = 'list-item')
        Array.from(document.querySelectorAll('.guest')).forEach(el => el.style.display = 'none')

    } else {
        Array.from(document.querySelectorAll('.guest')).forEach(el => el.style.display = 'list-item')
